...
module.exports = {
  name: "anuncios",
  description: "[MEMBER] Acesse um menu com todos os seus anúncios ativos.",
  ...
  run: async (client,interaction) => {
    ...
    try {
      ...
      if (announcementsData) {
        ...
        await interaction.reply({ content: "Você não possui anúncios ativos", ephemeral: true });

      }
    } catch (error) {

      console.error('Erro ao processar comando "anuncios":', error);
      await interaction.reply({ content: "Erro ao processar o comando catalog.", ephemeral: true });
